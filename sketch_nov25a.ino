...
#include <WiFi.h>
 ...
 const char* ssid = "Victor 的 iPhone";  // insert your SSID
 const char* password = "uniqlo1234";  // insert your password
...
void ClientRequest(String value1, String value2, String value3) {
  ...
  const char* event = "line";  //IFTTT事件名稱
  const char* apiKey = "cSR5iGRXSz1tSRbxOjZ-0p";  //IFTTT Applet key
...
char* RequestWeather() {
  ...
  const char* resource = "/data/2.5/weather?id=1668341&appid=552450103c0d98d12cbe2985b87c02e8";
